                ...
                <TouchableOpacity >
                    <View style={{
                        ...
                        <View style={{ flexDirection: 'row', marginTop: 10 }}>
                            <Text style={{ fontFamily: 'Rubik-Light', flex: 1, fontSize: 12, color: colors.black, paddingLeft: 4 }}>{item.business_address}</Text>
                ...
                <ImageBackground source={require('../images/bg_screen.png')} style={styles.image}>
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            fontFamily: 'Rubik-Light',
                            alignSelf: 'center',
                            alignContent: 'center', color: colors.white, paddingLeft: 10, fontSize: 22, fontWeight: 'bold'
                        }}>Favourites</Text>
                        <FlatList
                            scrollEnabled={true}
                            style={{
